             ...
             <header id="nav-wrapper">
                ...
                <NavLink to='/'>   
                    ...
                    <nav id="site-navigation" aria-label="Menu">
                        <ul id="main-menu">
                        <li><NavLink className="nav-link " exact to="/"><span className="nav-link-span"><span className="u-nav">Home</span></span></NavLink></li>
                        <li><NavLink exact to="/profile" className="nav-link"><span className="nav-link-span"><span className="u-nav">Profile</span></span></NavLink></li>
                        <li>{ this.props.user? 
