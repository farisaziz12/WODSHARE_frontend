...
class Navbar extends Component {
    render() {
        ...
        const cfFormatDate = formatedDate[2] >= 10? reformatedDate[2] + reformatedDate[3] + 0 + formatedDate[1] + formatedDate[2] : reformatedDate[2] + reformatedDate[3] + 0 + formatedDate[1] + 0 +formatedDate[2]
